...
from model import Encoder, MaterialGenerator
from dataset import MaterialsGeneratorDataset
...
def parse_arguments():
    ...
    # for data
    parser.add_argument('--data-path', default='./dataset/preprocess/slab_dataset_23137',
                        type=str, help='path to preprocessed data (relative path)')
    parser.add_argument('--raw-data-path', default='./dataset/raw/data_2022_04_29_1.csv',
...
def main():
    ...
    mp_ids = np.load(path.join(data_dir, 'item_ids.npy'), allow_pickle=True, fix_imports=True, encoding='latin1')
