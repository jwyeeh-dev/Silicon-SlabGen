...
def file2image(args):
	...
	for inputfile in inputfiles:
		...
		savefilename = './'+'[cell]'+tmp+'_32.json'#'.pickle'
...
def main():	
	...
	parser.add_argument('--input_file', type=str,nargs='+', help='a file path with the poscar or cif structure')
	parser.add_argument('--filetype', type=str,default='vasp',
